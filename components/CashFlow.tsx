...
import { 
  ...
  CreditCard, DollarSign, ArrowUpRight, ArrowDownRight, X, ChevronDown,
  Scissors, Truck, Building2, MoreHorizontal
} from 'lucide-react';
...
const CashFlow: React.FC<CashFlowProps> = ({ movements, setMovements, showToast }) => {
  ...
  const CATEGORIES = ['Modista', 'Transporte', 'Empresa', 'Varios'];
  
  const CATEGORY_ICONS: Record<string, React.ReactNode> = {
    'Modista': <Scissors size={14} />,
    'Transporte': <Truck size={14} />,
    'Empresa': <Building2 size={14} />,
    'Varios': <MoreHorizontal size={14} />
  };
  ...
  const handleAdd = () => {
    ...
    setFormData({ description: '', amount: 0, type: MovementType.INGRESO, method: PaymentMethod.EFECTIVO, category: 'Varios' });
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
        ...
        >
          ...
          <div className="flex items-center justify-between mb-4 relative z-10">
            ...
            <ArrowUpRight className="text-emerald-400" size={16} md:size={20} />
          </div>
        ...
        >
          <div className="absolute top-0 right-0 p-6 md:p-8 opacity-10 group-hover:scale-125 transition-transform duration-700">
            <TrendingDown size={60} md:size={80} />
          </div>
          <div className="flex items-center justify-between mb-4 relative z-10">
            <div className="flex items-center gap-3">
              <div className="p-3 bg-white text-rose-600 rounded-2xl shadow-sm"><TrendingDown size={20} md:size={24} /></div>
            ...
            <ArrowDownRight className="text-rose-400" size={16} md:size={20} />
          </div>
        ...
        >
          ...
          <div className="flex items-center justify-between mb-4 relative z-10">
            <div className="flex items-center gap-3">
              <div className="p-3 bg-white/10 rounded-2xl backdrop-blur-md"><Wallet size={20} md:size={24} /></div>
      ...
      <div className="bg-white p-6 md:p-10 rounded-[2.5rem] md:rounded-[3.5rem] shadow-xl shadow-slate-200/20 border border-slate-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-4 md:gap-6">
          ...
          <div className="lg:col-span-3 space-y-2">
            ...
            <div className="relative">
              <DollarSign className="absolute left-6 md:left-7 top-1/2 -translate-y-1/2 text-slate-400" size={20} md:size={24} />
              <input 
                type="number" 
          ...
          <div className="lg:col-span-2 flex items-end">
            ...
            >
              <Plus size={20} md:size={24} className="group-hover:rotate-90 transition-transform" />
      ...
      <div className="bg-white rounded-[3.5rem] shadow-xl shadow-slate-200/20 border border-slate-100 overflow-hidden">
        <div className="px-4 md:px-10 py-6 md:py-8 border-b border-slate-50 bg-slate-50/50 flex flex-col lg:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-4 w-full lg:w-auto">
            <div className="p-2.5 md:p-3 bg-indigo-600 text-white rounded-xl md:rounded-2xl shadow-xl shadow-indigo-200"><Wallet size={18} md:size={20} /></div>
            <div>
                  ...
                  >
                    ...
                    <td className="px-4 md:px-10 py-4 md:py-6">
                      <div className="flex items-center gap-3 md:gap-4">
                        <div className={`p-2 md:p-2.5 rounded-lg md:rounded-xl shadow-sm ${m.type === MovementType.INGRESO ? 'text-emerald-600 bg-white' : 'text-rose-600 bg-white'}`}>
                          {m.type === MovementType.INGRESO ? <TrendingUp size={16} md:size={18} /> : <TrendingDown size={16} md:size={18} />}
                        </div>
                        <div className="flex flex-col">
                    ...
                    <td className="px-4 md:px-10 py-4 md:py-6">
                      <div className="flex items-center gap-2 md:gap-3">
                        <CreditCard size={12} md:size={14} className="text-slate-300" />
